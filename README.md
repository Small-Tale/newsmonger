...
<img src="assets/stills/topics.png" alt="The topics sidebar: each watched topic with its category, its next-check dial, and one marked high priority." width="32%"> <img src="assets/stills/export.png" alt="The export dialog: stories out as Markdown or JSON, all of them or just the bookmarks." width="32%"> <img src="assets/stills/settings-source.png" alt="Settings: which AI provider does the searching, at what reasoning effort, and where its API key goes." width="32%">
