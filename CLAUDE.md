...
- Codebase map: `docs/ai/code-summary.md` (hand-written) · Requirements summary: `docs/ai/requirements-summary.md` (status block generated by `npm run docs:requirements`, notes region hand-written) — update both in the same change as the code they describe.
