...
**Start every fresh session by reading `docs/ai/code-summary.md` and `docs/ai/requirements-summary.md`.** Requirements docs are numbered `docs/N-topic.md` (1–27).
...
- Requirements docs: numbered `docs/N-topic.md` (currently 1–27), FR-N.M requirement ids, cross-referenced with relative links. New functional area → next number.
