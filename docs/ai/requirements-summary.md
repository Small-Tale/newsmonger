...
460 requirements across 29 documents (numbered 1–30, with 19 removed and never reused): 440 Shipped · 2 Partial · 12 Design only · 1 Deferred · 2 Rejected · 3 Decided.
...
| [30 — Import (and topic export)](../30-import.md) | Partial | 16 — 3 Shipped, 1 Partial, 12 Design only |
...
- [30 — Import (and topic export)](../30-import.md) — **FR-30.15** Partial: NEWS-317
