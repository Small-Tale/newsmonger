...
## [29 — Story Threads](../29-story-threads.md) — **Shipped** (NEWS-280 data, NEWS-281 pane, NEWS-282 timeline)
...
- Not done here: model-reported linking (NEWS-284); a model-written "what changed in this instalment" (FR-29.27, not proposed); the collapsed card's badge, which is what makes the timeline *discoverable* (NEWS-283).
...
## [27 — Where Data Is Stored](../27-data-location.md) — **Shipped** (NEWS-192, NEWS-230)
...
- The card **body**'s click is claimed as of NEWS-281 (expand in place, FR-3.63–3.66). Any new per-story control must live inside `.item-actions`, or the expand handler will fire alongside it.
