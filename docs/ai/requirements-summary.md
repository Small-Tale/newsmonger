...
539 requirements across 35 documents (numbered 1–36, with 19 removed and never reused): 524 Shipped · 2 Design only · 1 Deferred · 2 Rejected · 3 Decided · 7 Removed.
...
| [3 — Web UI](../3-ui.md) | Shipped | 73 — 68 Shipped, 5 Removed |
...
| [22 — Topic categories and the filter bar](../22-topic-categories.md) | Shipped | 16 — 16 Shipped |
| [23 — Retries and rate limits](../23-retries-and-rate-limits.md) | Shipped | 7 — 7 Shipped |
| [24 — Topic Discovery](../24-topic-discovery.md) | Shipped | 41 — 41 Shipped |
...
| [28 — Demo Capture (the hero and the stills)](../28-demo-capture.md) | Shipped | 22 — 22 Shipped |
...
| [36 — Default Topics from Profiles](../36-profile-topics.md) | Partial | 11 — 9 Shipped, 2 Design only |
...
- [36 — Default Topics from Profiles](../36-profile-topics.md) — **FR-36.10** Design only
