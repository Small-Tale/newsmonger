...
488 requirements across 31 documents (numbered 1–32, with 19 removed and never reused): 476 Shipped · 1 Partial · 1 Deferred · 2 Rejected · 3 Decided · 5 Removed.
...
| [3 — Web UI](../3-ui.md) | Shipped | 70 — 67 Shipped, 3 Removed |
| [4 — CLI, Server, and Storage](../4-cli-server-storage.md) | Shipped | 23 — 23 Shipped |
