...
520 requirements across 34 documents (numbered 1–35, with 19 removed and never reused): 506 Shipped · 1 Design only · 1 Deferred · 2 Rejected · 3 Decided · 7 Removed.
...
| [35 — Location](../35-location.md) | Partial | 9 — 8 Shipped, 1 Design only |
...
- [35 — Location](../35-location.md) — **FR-35.9** Design only
