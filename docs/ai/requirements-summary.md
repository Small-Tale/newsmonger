...
435 requirements across 28 documents (numbered 1–29, with 19 removed and never reused): 330 Shipped · 1 Partial · 1 Deferred · 2 Rejected · 1 Decided · 100 no marker.

| Doc | Status | Requirements |
| --- | --- | --- |
| [1 — Topics and Scheduling](../1-topics-and-scheduling.md) | Shipped | 15 — 4 Shipped, 11 no marker |
| [2 — News Checks and Deduplication](../2-news-checks-and-dedup.md) | Shipped | 18 — 8 Shipped, 10 no marker |
| [3 — Web UI](../3-ui.md) | Shipped | 61 — 50 Shipped, 11 no marker |
| [4 — CLI, Server, and Storage](../4-cli-server-storage.md) | Shipped | 19 — 9 Shipped, 10 no marker |
| [5 — Desktop App (Tauri)](../5-desktop-app.md) | Partial | 21 — 18 Shipped, 1 Partial, 1 Decided, 1 no marker |
| [6 — AI Providers](../6-providers.md) | Shipped | 18 — 13 Shipped, 5 no marker |
...
| [9 — Subscription Providers](../9-subscription-providers.md) | Shipped | 22 — 20 Shipped, 1 Rejected, 1 no marker |
...
| [24 — Topic Discovery](../24-topic-discovery.md) | Shipped | 37 — 22 Shipped, 15 no marker |
| [25 — Topic Editing](../25-topic-editing.md) | Shipped | 12 — 12 Shipped |
...
| [29 — Story Threads](../29-story-threads.md) | Not stated | 36 — 36 no marker |
...
100 requirements state no status. The marker is optional, so this is not an error — but it is the list of requirements whose state this file cannot report, and it is where a stale status hides instead.

- [1 — Topics and Scheduling](../1-topics-and-scheduling.md) — FR-1.1–1.9, FR-1.11, FR-1.13 (11)
- [2 — News Checks and Deduplication](../2-news-checks-and-dedup.md) — FR-2.1–2.10 (10)
- [3 — Web UI](../3-ui.md) — FR-3.1, FR-3.1a, FR-3.2, FR-3.2a, FR-3.2c, FR-3.3–3.8 (11)
- [4 — CLI, Server, and Storage](../4-cli-server-storage.md) — FR-4.1–4.5, FR-4.5a, FR-4.6–4.7, FR-4.9–4.10 (10)
- [5 — Desktop App (Tauri)](../5-desktop-app.md) — FR-5.21 (1)
- [6 — AI Providers](../6-providers.md) — FR-6.0–6.4 (5)
- [9 — Subscription Providers](../9-subscription-providers.md) — FR-9.1 (1)
