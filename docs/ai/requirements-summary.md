...
- FR-3.43 SVG favicon served and asserted; app icons generated from `assets/logo.svg`; `mask-icon.svg` unwired (opaque square would tint as a block) — NEWS-115: **Shipped**
