...
- FR-27.14–27.16 Chromium enters the sidecar closure (FR-5.3) and the FR-5.6 entitlements need **re-verifying**, not extending; rendering is a background job with progress; video additionally needs ffmpeg, which cannot be bundled: **Design only**
