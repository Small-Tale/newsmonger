...
433 requirements across 28 documents (numbered 1–29, with 19 removed and never reused): 328 Shipped · 1 Partial · 1 Deferred · 2 Rejected · 1 Decided · 100 no marker.

| Doc | Status | Requirements |
| --- | --- | --- |
| [1 — Topics and Scheduling](../1-topics-and-scheduling.md) | Shipped | 14 — 3 Shipped, 11 no marker |
| [2 — News Checks and Deduplication](../2-news-checks-and-dedup.md) | Shipped | 17 — 7 Shipped, 10 no marker |
