...
460 requirements across 29 documents (numbered 1–30, with 19 removed and never reused): 437 Shipped · 1 Partial · 16 Design only · 1 Deferred · 2 Rejected · 3 Decided.
...
| [21 — Export and Feed](../21-export-and-feed.md) | Shipped | 12 — 11 Shipped, 1 Deferred |
...
| [30 — Import (and topic export)](../30-import.md) | Design only | 16 — 16 Design only |
...
- [30 — Import (and topic export)](../30-import.md) — **FR-30.1** Design only
- [30 — Import (and topic export)](../30-import.md) — **FR-30.2** Design only
- [30 — Import (and topic export)](../30-import.md) — **FR-30.3** Design only
- [30 — Import (and topic export)](../30-import.md) — **FR-30.4** Design only
- [30 — Import (and topic export)](../30-import.md) — **FR-30.5** Design only
- [30 — Import (and topic export)](../30-import.md) — **FR-30.6** Design only
- [30 — Import (and topic export)](../30-import.md) — **FR-30.7** Design only
- [30 — Import (and topic export)](../30-import.md) — **FR-30.8** Design only
- [30 — Import (and topic export)](../30-import.md) — **FR-30.9** Design only
- [30 — Import (and topic export)](../30-import.md) — **FR-30.10** Design only
- [30 — Import (and topic export)](../30-import.md) — **FR-30.11** Design only
- [30 — Import (and topic export)](../30-import.md) — **FR-30.12** Design only
- [30 — Import (and topic export)](../30-import.md) — **FR-30.13** Design only
- [30 — Import (and topic export)](../30-import.md) — **FR-30.14** Design only
- [30 — Import (and topic export)](../30-import.md) — **FR-30.15** Design only
- [30 — Import (and topic export)](../30-import.md) — **FR-30.16** Design only
...
- The only doc in this file with **no shipped requirement in it**. Written as a design because both tickets asked questions ("ask clarifying questions as needed") that were never answered; the doc names every assumption inline so the wrong ones are correctable in one place instead of spread through an implementation.
