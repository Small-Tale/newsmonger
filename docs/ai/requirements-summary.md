...
541 requirements across 35 documents (numbered 1–36, with 19 removed and never reused): 526 Shipped · 2 Design only · 1 Deferred · 2 Rejected · 3 Decided · 7 Removed.
...
| [22 — Topic categories and the filter bar](../22-topic-categories.md) | Shipped | 17 — 17 Shipped |
