...
- **docs/22-topic-categories.md** (NEWS-97) — topic categories. FR-22.1–22.6 taxonomy as seeded data, slug-not-label storage, retire-not-delete, most-specific label resolution, "no subcategory" as a rendered *Other*: **Shipped**. FR-22.7–22.10 topic fields, auto-classification, sidebar pills, filter bar: **Design only** — blocked on three owner decisions listed in that doc
