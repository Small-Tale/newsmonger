...
546 requirements across 35 documents (numbered 1–36, with 19 removed and never reused): 532 Shipped · 1 Design only · 1 Deferred · 2 Rejected · 3 Decided · 7 Removed.
...
| [28 — Demo Capture (the hero and the stills)](../28-demo-capture.md) | Shipped | 23 — 23 Shipped |
